            ...
            if(@Auth::Check($token) !== null and @Auth::Check($token)) {
                switch($requestMethod) {
                    case "POST":
                        ...
                        if(isset($tipoDeProductoId) and !empty($tipoDeProductoId) and isset($nombre) and !empty($nombre) and isset($vigenciaDesde) and !empty($vigenciaDesde) and isset($vigenciaHasta) and !empty($vigenciaHasta) and isset($visible) and !empty($visible) and isset($disponible) and !empty($disponible) and isset($descripcion) and !empty($descripcion)) {
                            ...
                            $sql .= " values (".$tipoDeProductoId.", '".$nombre."', ".$vigenciaDesde.", ".$vigenciaHasta.", ".$visible.", ".$disponible.", '".$descripcion."'";
