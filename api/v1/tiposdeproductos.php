                ...
                switch($requestMethod) {
                    case "GET":
                        ...
                        if(isset($id) and !empty($id))
                            ...
                            $sql = "select Id, Nombre, VigenciaDesde, VigenciaHasta, Visible from protipodeproducto where ClienteId=".$clienteId.";";
                    ...
                    case "POST":
                        ...
                        if(isset($nombre) and !empty($nombre) and isset($vigenciaDesde) and !empty($vigenciaDesde) and isset($vigenciaHasta) and !empty($vigenciaHasta) and isset($visible) and (!empty($visible) or $visible == 0)) {
                            $sql = "insert into protipodeproducto (ClienteId, Nombre, VigenciaDesde, VigenciaHasta, Visible) values (".$clienteId.", '".$nombre."', ".$vigenciaDesde.", ".$vigenciaHasta.", ".$visible.");";
